...
export const formulasTable = [
	{
		logo: avatar1,
		name: "PAW and PAWE properties",
		email: "General",
		subdomain: "Administrator",
		domain: "Muhd. Aidil Syazwan",
		revN: Math.random() * 100,
		status: "Online",
		date: "14/06/21",
	},
	{
